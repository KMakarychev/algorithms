...
// the maximum independent set. This algorithm uses a bottom-up 
// approach.
...
// A top-down implementation of the dynamic programming algorithm.
// FindIndependentSetRecursively returns the cost of the maximum
// independent set in the set {0,...,k}
int FindIndependentSetRecursively (const std::vector<int>& weights, 
                                   std::vector<int>& dpTable, 
                                   size_t k)
{
   // Make sure this function receives valid input.
